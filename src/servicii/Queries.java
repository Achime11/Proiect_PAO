...
public class Queries {
    public static final String READ_PERSOANE = "SELECT CNP, nume, prenume, adresa, telefon FROM CMDB.persoana;";
    public static final String READ_PROGRAMARI = "SELECT id_programare, data, detaliiProgramare, recomandari, CNP_C, CNP_M  FROM CMDB.programare;";
    public static final String READ_ECHIPAMENTE = "SELECT ID_Echipament, numeProducator, telefon, numeEchipament, anProductie, pret FROM CMDB.echipament;";
    public static final String READ_CLIENTI = "SELECT p.CNP, p.nume, p.prenume, p.adresa, p.telefon,c.asigurat,c.rezultatTestCOVID,c.salariat,c.boli,c.alergeni,c.grupaSange  FROM CMDB.persoana p\n" +
            "join CMDB.client c\n" +
            "on c.CNP_C = p.CNP;";
    public static final String READ_MEDICI = "SELECT p.CNP, p.nume, p.prenume, p.adresa, p.telefon,m.specializare,m.aniExperienta,m.dataAngajarii  FROM CMDB.persoana p\n" +
            "join CMDB.medic m\n" +
            "on m.CNP_M = p.CNP;";
